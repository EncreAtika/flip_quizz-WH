...
- Interface du jeu
- Règles de gestion
- Un Quiz est caractérisé par un titre et une description. 
- Chaque Quiz est relié à 6 catégories au maximum. Une catégorie ne peut être reliée qu’à un seul quiz.
...
### Spécifications du logiciel d’administratio:
